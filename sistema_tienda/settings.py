...
SECRET_KEY = 'django-insecure-ny6n(@%lzt_nje0u%v3-wv^s70pt3po39d1u+1su5i1@z_ankf'
...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize', # <-- ¡Importante para los reportes!
    'tienda',                  # <-- ¡ESTA ES LA LÍNEA CLAVE!
]
...
# Dónde encontrar la página de login (¡ESTA LÍNEA ARREGLA TU ERROR!)
LOGIN_URL = 'tienda:login'

# Dónde ir después de un login exitoso (si no se especifica)
LOGIN_REDIRECT_URL = 'tienda:home'

# Dónde ir después de cerrar sesión
